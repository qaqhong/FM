...
<body>
	<div>
		<ul class="breadcrumb" style="margin: 0px;">
			<li>实训项目单（Knowledge）管理</li>
			
		</ul>
	</div>
<form action="${pageContext.request.contextPath }/ppt/pptknowledgeinsert" id="f1" enctype="multipart/form-data" method="post" class="form-horizontal">
