...
<body>
	<div>
		<ul class="breadcrumb" style="margin: 0px;">
			<li>实训项目单（Phone）管理</li>
			
		</ul>
	</div>
<form action="ppt/insertPhoneSubmit" id="f1" enctype="multipart/form-data" method="post" class="form-horizontal">
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<input type="file" name="phone_file"  class="form-control" />
					</div>
				</div>
			</div>
