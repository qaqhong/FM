...
<html lang="zh-CN">
	...
	<head>
		...
		<link rel="stylesheet" href="resource/files/bootstrap.min.css" >
		<link rel="stylesheet" href="resource/files/font-awesome.min.css" >
		<link rel="stylesheet" href="resource/files/index.css" >
		<link rel="stylesheet" href="resource/files/content.css"  type="text/css">
		<style>
			tr{
			...
			<div class="container">
				<div class="row">
					<div class="logo col-md-4 col-sm-5 col-xs-11">
						<a href="#">
							<img src="resource/files/logo.png" alt="">
						</a>
					</div>
				</div>
			</div>
												...
												<div class="wp_entry">
													<div class="wp_articlecontent">
														<div id="wp_content_w8_0" class="paging_content" style="display:">
                                							...
                                							<form action="ppt/pptlist" class="form-inline" method="post" style="width:900px;text-indent: 2.5em; ">
								                                <table style="border-collapse:separate; border-spacing:0px 10px;">
								                                <c:forEach items="${listpc }" var="me">
								                                <c:url value="/ppt/pcdownload" var="downurl">
            													<c:param name="filename" value="${me.pptPCname}"></c:param>
        														</c:url>
								                                <tr>
								                                	<td><a href="${pageContext.request.contextPath }/ppt/pcdownload?id=${me.pptPCid}">${me.pptPCname}</a></td>
								                               </tr>
								                                 </c:forEach> 
