				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							...
							class="user-info"> <small>${userLogin.username }</small>
						</span> <i class="icon-caret-down"></i>
					</a>
						<ul
							class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							
							<li><a href="show"  target="mainframe"> <i class="icon-user"></i> 个人资料
							</a></li>
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a
						href="user/select" target="mainframe">
			    ...
			    <li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> ${menu.mname } </span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
							<c:forEach items="${mlogin }" var="menu2">
							<c:if test="${menu.mid == menu2.pid }">
                            <li><a href="${menu2.murl }" target="mainframe"> <i
									class="icon-double-angle-right"></i> ${menu2.mname }
							</a></li>
							</c:if>
							</c:forEach>
						</ul>
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="user/select"
