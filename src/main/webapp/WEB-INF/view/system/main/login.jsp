			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="icon-leaf green"></i> <span class="red">电子商城实训教学门户</span> <span
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input id="userId"
														value="" name="username" type="text" class="form-control"
														placeholder="请输入账号:admin/张三/李四/王五" /> <i class="icon-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input id="userPw"
													   value="" name="userpassword" type="password" class="form-control"
